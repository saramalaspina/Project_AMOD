...
alpha = 0.5 # Variabile alpha da far variare nella funzione obiettivo
...
obj = (alpha * gp.quicksum(c[i] for i in jobs_giocatore1) + (1-alpha)*gp.quicksum(c[i] for i in jobs_giocatore2))
